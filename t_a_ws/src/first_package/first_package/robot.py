...
class Robot(Node):
    def __init__(self):
        ...
        self.goal_subs = self.create_subscription(Pose,'new_partial_goal_pose',self.goal_callback,10)
    ...
    def goal_callback(self,data):
        ...
        # self.get_logger().info("ROBOT.PY New Goal callback: {}".format(data))
        ...
        self.goal_pose.x = self.goal_pose.x * self.tile_size + 2
        self.goal_pose.y = self.goal_pose.y * self.tile_size + 2
